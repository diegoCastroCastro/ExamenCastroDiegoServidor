...
a persistence unit "ExamenCastroDiegoServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenCastroDiegoServidor\pom.xml":
...
artifact ("ExamenCastroDiegoServidor.war") is already built. You can build
